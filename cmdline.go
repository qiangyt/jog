...
func PrintHelp() {
	...
	fmt.Printf("  -g,  --grok <grok pattern name>                             For non-json log line. The default patterns are saved in " + config.DefaultGrokPatternsDir() + "\n")
	...
	fmt.Printf("  ,    --reset-default-grok-patterns-dir                      Save default GROK patterns to " + config.DefaultGrokPatternsDir() + "\n")

...
// 	protoc        v3.18.1
// source: pkg/server/conf/conf.proto
...
func (x *Bootstrap) Reset() {
	*x = Bootstrap{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[0]
...
func (*Bootstrap) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{0}
}
...
func (x *Server) Reset() {
	*x = Server{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Server) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{1}
}
...
type Log struct {
	...
	Target   string `protobuf:"bytes,1,opt,name=target,proto3" json:"target,omitempty"`                     // "stdio" or "file"
	FilePath string `protobuf:"bytes,2,opt,name=file_path,json=filePath,proto3" json:"file_path,omitempty"` // only used if target == "file"
}

func (x *Log) Reset() {
	*x = Log{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Log) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{2}
}
...
func (x *Data) Reset() {
	*x = Data{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Data) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{3}
}
...
func (x *Server_HTTP) Reset() {
	*x = Server_HTTP{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Server_HTTP) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *Server_GRPC) Reset() {
	*x = Server_GRPC{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Server_GRPC) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *Data_Database) Reset() {
	*x = Data_Database{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Data_Database) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}
...
func (x *Data_Redis) Reset() {
	*x = Data_Redis{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_server_conf_conf_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Data_Redis) Descriptor() ([]byte, []int) {
	return file_pkg_server_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}
...
var File_pkg_server_conf_conf_proto protoreflect.FileDescriptor

var file_pkg_server_conf_conf_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x70, 0x6b, 0x67, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6e,
	...
	0x70, 0x69, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0xc8, 0x02, 0x0a, 0x06,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2b, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x02,
	...
	0x74, 0x74, 0x70, 0x12, 0x2b, 0x0a, 0x04, 0x67, 0x72, 0x70, 0x63, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x3a, 0x0a, 0x03, 0x4c, 0x6f, 0x67, 0x12, 0x16, 0x0a,
	...
	0x74, 0x68, 0x22, 0xdd, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64,
	...
	0x75, 0x74, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x71, 0x69, 0x61, 0x6e, 0x67, 0x79, 0x74, 0x2f, 0x6a, 0x6f, 0x67, 0x2f, 0x70, 0x6b, 0x67,
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x3b, 0x63, 0x6f, 0x6e,
	0x66, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pkg_server_conf_conf_proto_rawDescOnce sync.Once
	file_pkg_server_conf_conf_proto_rawDescData = file_pkg_server_conf_conf_proto_rawDesc
)

func file_pkg_server_conf_conf_proto_rawDescGZIP() []byte {
	file_pkg_server_conf_conf_proto_rawDescOnce.Do(func() {
		file_pkg_server_conf_conf_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_server_conf_conf_proto_rawDescData)
	})
	return file_pkg_server_conf_conf_proto_rawDescData
}

var file_pkg_server_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_pkg_server_conf_conf_proto_goTypes = []interface{}{
...
var file_pkg_server_conf_conf_proto_depIdxs = []int32{
...
func init() { file_pkg_server_conf_conf_proto_init() }
func file_pkg_server_conf_conf_proto_init() {
	if File_pkg_server_conf_conf_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_server_conf_conf_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_server_conf_conf_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Server); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_server_conf_conf_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Log); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_server_conf_conf_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_server_conf_conf_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_server_conf_conf_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_server_conf_conf_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_server_conf_conf_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_server_conf_conf_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pkg_server_conf_conf_proto_goTypes,
		DependencyIndexes: file_pkg_server_conf_conf_proto_depIdxs,
		MessageInfos:      file_pkg_server_conf_conf_proto_msgTypes,
	}.Build()
	File_pkg_server_conf_conf_proto = out.File
	file_pkg_server_conf_conf_proto_rawDesc = nil
	file_pkg_server_conf_conf_proto_goTypes = nil
	file_pkg_server_conf_conf_proto_depIdxs = nil
}
